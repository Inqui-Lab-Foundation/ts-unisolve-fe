                    ...
                    >
                        <g id="Plan_x0020_1">
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id &&
                                    addClassName.id === 'tiruchirappalli'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id &&
                                    addClassName.id === 'mayiladuthurai'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                ...
                                className={`fil0 str0 ${
                                    addClassName.id &&
                                    addClassName.id === 'tiruvannamalai'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id &&
                                    addClassName.id === 'ramanathapuram'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
