        ...
        <div className="container bg-light">
            <div className="row">
                ...
                <div className="col-md-7 col-12 h-100">
                    <div className="personal-detail p-5 bg-white shadow rounded border h-100">
                        ...
                        <div className="row my-2">
                            ...
                            <div className="col-8 text-capitalize fs-4">: {props?.ideaDetails?.evaluator_ratings[0]?.challenge_response?.team?.mentor?.full_name}</div>
                        </div>
                        <div className="row my-2">
                            <div className="col-4 fw-bold fs-4">Team Name</div>
                            <div className="col-8 text-capitalize fs-4">: {props?.ideaDetails?.evaluator_ratings[0]?.challenge_response?.team?.team_name}</div>
                        </div>
                        <div className="row my-2">
                            <div className="col-4 fw-bold fs-4">Team Members</div>
                            <div className="col-8 text-capitalize fs-4">: {props?.ideaDetails?.evaluator_ratings[0]?.challenge_response?.team_members.toString()}</div>
                        </div>
                        <div className="row my-2">
                            <div className="col-4 fw-bold fs-4">Organisation Code</div>
                            <div className="col-8 text-capitalize fs-4">: {props?.ideaDetails?.evaluator_ratings[0]?.challenge_response?.team?.mentor?.organization?.organization_code}</div>
                        </div>
                        <div className="row my-2">
                            <div className="col-4 fw-bold fs-4">Oraganisation Name</div>
                            <div className="col-8 text-capitalize fs-4">: {props?.ideaDetails?.evaluator_ratings[0]?.challenge_response?.team?.mentor?.organization?.organization_name}</div>
                        </div>
                    </div>
                </div>
                {/* ---------------------------------- */}
                ...
                <div className="col-md-5 col-12 h1-100">
                    {
                        props?.ideaDetails?.evaluator_ratings[0]?.challenge_response?.evaluation_status &&
                        <div className="status p-5 bg-white shadow rounded border h-100">
                            ...
                            <div className="row my-2">
                                ...
                                <div className={`${props?.ideaDetails?.evaluator_ratings[0]?.challenge_response?.evaluation_status=='SELECTEDROUND1'?'text-success':'text-danger'} col-10 text-capitalize fs-4`}>
                                : {props?.ideaDetails?.evaluator_ratings[0]?.challenge_response?.evaluation_status ==
                                    'SELECTEDROUND1'
                                        ? 'Accepted'
                                        : 'Rejected'}
                ...
                <div className="col-12 my-4">
                    ...
                    <div className="row my-2">
                        <div className="col-12 fw-bold fs-4">SDG <span className="col-10 text-capitalize fs-4"> : {props?.ideaDetails?.evaluator_ratings[0]?.challenge_response?.sdg}</span></div>
