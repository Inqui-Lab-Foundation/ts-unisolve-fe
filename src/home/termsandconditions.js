                            ...
                            <Col md={12}>
                                ...
                                <Card className="mb-5 p-4 ">
                                    <CardBody>
                                        ...
                                        (&quot;Agreement&quot;) is an agreement between you (“you” or “User”) and School Innovation Challenge Partners (defined below, referred to as &quot;SICP”, &quot;us,&quot; &quot;we,&quot; or &quot;our&quot;), which govern your use of the website: www.unisolve.org (&quot;Site&quot;). By using or accessing our Site or downloading materials from the Site or availing yourself of the School Innovation Challenge materials and services (defined below, “SIC materials and services”)  in any manner, you agree to have read, understood and to be legally bound by this Agreement. The Agreement includes all the schedules or additional policies attached hereunder.
                                        </p>
                                        <h6>Definitions</h6>
                                        <ol>
                                            <li>School Innovation Challenge Partners (“SICP”) means the association of key partners conducting the School Innovation Challenge Program 2022 (“ SIC”) and includes Inqui-Lab Foundation, Government Partners, Implementation Partners  and UNICEF.</li>
                                            <li>School Innovation Challenge material and services (“SIC material and services”) means access to learning videos, design supplements, product and services, other content, visual interfaces, multimedia content including but not limited to musical works and sound recordings,  features, information, graphics, design, compilation, computer code, software, products, and all other elements of the Site provided by Inqui-Lab Foundation.</li>
                                        </ol>
                                        ...
                                        <p>SICP reserves the right to update or modify the terms of this Agreement  at any time without prior notice, and such changes will be effective immediately upon posting through the Site. </p>
                                        <p>We encourage you to periodically review this Agreement to see if there have been any changes that may affect you. If you do not agree to this Agreement as modified, then you must terminate your use of the Site and SIC materials and services. Your continued use of the Site and SIC materials and services will signify your continued agreement to this Agreement as it may be revised from time to time.</p>
                                        <h6 className='my-5'>2. Authorized Use</h6>
                                        <ol>
                                            <li><p>The User may access and use the Site and SIC material and services as set forth in this Agreement consistent with the intended features of the program, provided that i. the same is used solely for noncommercial or educational purposes and ii. you do not engage in any of the prohibited uses described hereunder.</p>
                                           
                                            </li>
                                            <li><p>While using the Site and SIC material and services, you are required to comply with all applicable statutes, orders, regulations, rules, and other laws. You may not use the Site for any fraudulent or unlawful purpose, and you may not take any action to interfere with a Site or any other user&#39;s use of a Site. You may not and you expressly agree that you will not, including but not limited to, do any of the following, which violate this Agreement:
                                            ...
                                            </p><p>2.6 Remove, circumvent, disable, damage or otherwise interfere with any security-related features of the Site and/or SIC materials and services, features that prevent or restrict the use or copying of any part of the same, or features that enforce limitations on the use of the Site and/or SIC materials and services or any content therein.</p><p>2.7 Disseminate on the Site any viruses, worms, cancel bots, spyware, adware or other malicious computer code, file or program that is harmful, invasive or may or is intended to damage or hijack the operation of, or monitor the use of, any hardware, software or equipment.</p><p>2.8 Use any data mining, bots, spiders, automated tools or similar data gathering and extraction methods, directly or indirectly, on the Site or to collect any information from the Site or any other user of the Site.</p><p>2.9 Assist or permit any persons in violating this Agreement or applicable statutes, orders, regulations, rules, and other laws governing the use of websites.</p></li>
                                        </ol>
                                        <h6 className='my-5'>
                                            3. Intellectual Property Rights
                                        </h6>
                                        <p>All content (“Content”), available through the Site is owned by SICP . Except as set forth herein or otherwise agreed in writing by the SICP or other rights owner(s), to sell, license, publish, or otherwise use of any Content available on the Site is strictly prohibited.
                                        </p><p>The Site and  SIC materials and services are the valuable proprietary and intellectual property of its licensors ie., SICP, including but without limitation, all right, title, interest, moral rights, copyrights, trademarks, patents and any other Intellectual Property thereto.
                                        </p><p>You may use the Site and SIC materials and services from the Site explicitly made available by the  SICP for public use, provided that you (a) keep intact all copyright and other proprietary notices; (b) use appropriate attribution where feasible (e.g. &quot;Source: School Innovation Challenge Program 2022, unisolve.org) (c) make no modifications to the SIC materials and services; (d) do not make any additional representations or warranties relating to SIC materials and services on behalf of the SICP; and (e) do not use the SIC materials and services in any way that the SICP deems inappropriate or inadvisable in its sole discretion.</p><p>Any rights not expressly granted herein are reserved.
                                        </p>
                                        ...
                                        <ol>
                                            ...
                                            <li>SIC makes no representations that it will publish or make available on the Site and/or SIC materials and services any User Submissions, and reserves the right, in its sole discretion, to refuse to allow any User Submissions, or to remove any User Submission at any time with or without notice.</li>
                                            <li>By submitting Content, other than personally identifiable information, you grant to the SICP (or warrant that the owner of such Content has expressly granted to the SICP) a royalty-free, perpetual, irrevocable and unrestricted right and license (a) to use, reproduce, display, modify, adapt, publish, translate, transmit, distribute or otherwise make available to others such Content (in whole or in part and for any purpose) worldwide and/or to incorporate it in other works in any form, media or technology now known or hereafter developed; (b) to exercise all copyright, trademark, publicity, privacy and other proprietary rights with regard to such Content; and (c) to use your name, likeness and/or other biographical information in any and all media and/or communications.  You also agree that the SICP is free to use any ideas, concepts, know-how or techniques that you send to us for any purpose.</li>
                                        ...
                                        <p>Any information, statements, opinions or other Content provided by third parties and made available on our Site are those of the respective author(s) and not the SICP.  We do not guarantee the validity, accuracy, truthfulness, completeness, reliability or usefulness of any information, statement, opinion or other Content on our Site other than from an authorized SICP representative acting in his or her official capacity. </p>
                                        <h6 className='my-5'>VII. Links to Third-Party Websites</h6>
                                        <p>We may provide on the Site, solely as a convenience to Users, links to websites operated by third parties. If you use these links, you will leave our Site. If you decide to visit any linked website, you do so at your own risk and it is your responsibility to take all the necessary protective measures. The SICP does not make any warranty or representation regarding, or endorse or otherwise sponsor, any linked websites or the information appearing thereon or any of the products or services described thereon.</p>
                                        ...
                                        <p>The SICP maintains a presence on social media websites, including Facebook, YouTube, LinkedIn, Instagram and Twitter (collectively, &quot;Social Media Pages&quot;). All visitors to our Social Media Pages must comply with the respective social media website&#39;s Terms of Use. We take reasonable care in our postings to our Social Media Pages, and may remove, in our  sole discretion,  postings that we determine are inappropriate or offensive.</p>
                                        <h6 className='my-5'>IX. User Disagreements</h6>
                                        <p>Your use of the Site and SIC materials and services may bring you into contact with other users, and their User Content, such as through networked game play, chat, and other user communication features of the platform. You are solely responsible for your involvement with other users. If you have a dispute with one or more Users, you release SICP (and SICP officers, directors, agents, subsidiaries, joint ventures and employees) from claims, demands and damages (including, but not limited to, actual, special, consequential and punitive) of every kind and nature, known and unknown, arising out of or in any way connected with such disputes.</p>
                                        <h6 className='my-5'>X. Confidential Information</h6>
                                        <p>Certain Content, information or software you access through the Site may contain confidential information of SICP. You agree to keep the same confidential by exercising the necessary care required to prevent its disclosure. Notwithstanding the above, you will not disclose, divulge, distribute, publish, transmit or transfer information to any third party or use the same for any purpose whatsoever other than as expressly authorized by these Terms. Your obligations with respect to the confidential information, whether or not deemed trade secret under applicable law, remain in effect until such time as the particular information becomes publicly known through no action by you.</p>
                                        <h6 className='my-5'>XI. Termination</h6>
                                        <p>The Site and this Agreement are in effect until terminated by the SICP. In addition to any right or remedy that may be available to the SICP under applicable law, and subject to regulatory requirements, the SICP may suspend, limit or terminate all or a portion of your access to the Site or any of their features at any time with or without notice and with or without cause, including without limitation, if the SICP believes that you have violated or acted inconsistently with the letter or spirit of this Agreement. The provisions of this Agreement concerning authorized use, intellectual property rights, user-submitted information, disclaimer of warranty, limitation of liability and indemnity, as well as any other provisions that by their nature should survive, shall survive any such termination.</p>
                                ...
                                <Card className='mb-5 p-4 '>
                                    ...
                                    <CardBody>
                                        ...
                                        <p>The School Innovation Challenge Partners (“SICP”) understand, respect and value your privacy, and we want to help make your experience with our Site and SIC material and services satisfying and safe. This policy describes the information we collect on unisolve.org in connection with our Services, and explains how we use and disclose this information. This privacy policy (&quot;Privacy Policy&quot;) sets forth the privacy practices and policies governing our Site. By accessing and/or using the Site, you agree to be bound by the provisions of this Privacy Policy.</p>
                                        <p>There are several ways you can use our services – to get inspired, to share content, participate in the school Program and other events, as and when organized. As you use our Site and SIC materials and services, we want you to be clear how we’re using information and the ways in which you can protect your privacy.
...
“Personal information”, is any information that enables us to identify you, directly or indirectly, by reference to an identifier such as your name, identification number, location data, online identifier or one or more factors specific to you. Personal information includes “sensitive personal information” and “pseudonymised personal information” but excludes anonymous information or information that has had the identity of an individual permanently removed.
                                        ...
                                        <p>We collect the Personal Information, wherever necessary, as part of the SIC for registration, communication, progress tracking and evaluation purposes.</p>
                                        <h6 className='my-5'>1. Information We Collect and How We Use It
                                        </h6>
                                        <p>1.1. Information You Provide to Us-  We collect the Personal Information of the participants as part of entry to the School Innovation Challenge Program 2022 (“SIC”).</p>
                                        ...
                                        <p>1.4. The SICP gathers and retains Personal Information about you, including name, email address, physical address, phone number, or any  other personal or background information when you voluntarily submit it to us.</p>
                                        ...
                                        <p>1.6. We will hold and use the Personal Information only as long as is necessary to implement, administer and manage your participation in SIC. 
                                        </p>
                                        <h6 className='my-5'>2. Social Networking Activities</h6>
                                        <p>Our Site may allow you to enter social networking websites such as Facebook, Instagram, YouTube, LinkedIn, and Twitter (collectively, “Social Media Pages”). If you choose to follow, like, friend, share, or comment on our Social Media Pages, or otherwise share information on these social networking websites, we may receive information about you. We may use such information about you in a variety of ways, including to enhance your experience with the SICP outreach and to communicate with you about new SICP activities. </p>
                                        ...
                                        <p>4.3 Student responses are collected as part of the SIC online course through the Site through the modes, including but not limited, to assessments and Idea submission.</p>
                                        ...
                                        <p>5.2. We use the collected data to communicate with the teachers to share useful updates about the SIC.</p>
                                        ...
                                        <p>5.4. Student responses are evaluated by SICP team members to shortlist student teams for further rounds;</p>
                                        ...
                                        <p>5.6. Selected students responses, at the sole discretion of SICP team members,  are shared with industry experts and mentors for feedback purposes;</p>
                                        ...
                                        <p>We may occasionally amend this Privacy Policy to reflect SIC activities and user feedback and we reserve the right to make changes to this Privacy Policy at any time. If at any point we decide to use Personal Information in a manner that is materially different from that stated at the time it was collected, we will endeavor to notify you of such changes prior to implementing them by posting a revised Privacy Policy with a new “Last Updated” date, displaying the word “updated” next to the Privacy Policy link on each page of the Site or otherwise.  The use of your information is subject to the Privacy Policy and Terms of Use in effect at the time of use. The provisions contained in this Privacy Policy supersede all previous notices or policies regarding our privacy practices with respect to our Site. We encourage you to check frequently to see the current Privacy Policy to be informed of how the SIC is committed to protecting your information and providing you with improved content on our Sites in order to enhance your experience.</p>
