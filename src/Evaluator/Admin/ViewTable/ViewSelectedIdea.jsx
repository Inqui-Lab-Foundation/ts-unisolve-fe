...
const ViewSelectedIdea = () => {
    ...
    const evaluatedIdeaL2 = {
        ...
        columns: [
            ...
            {
                name: 'Overall',
                // selector: (row) => row.evaluator_ratings,
                // selector: (a, b) => {
                //     a.evaluator_ratings - b.evaluator_ratings;
                // },
                // sorter: (a, b) => a.evaluator_ratings - b.evaluator_ratings,
                // sortOrder: sortedInfo.columnKey === 'age' && sortedInfo.order,
                // cell :(row) => {
                //     return[row.evaluator_ratings ? row.evaluator_ratings.length > 0 ? average(row.evaluator_ratings[0].overall) :' ' :' '];},
                // sortable: (a, b) => {
                //     // class: 'sort-up',
                //     return [a.evaluator_ratings - b.evaluator_ratings];
                //     // (row, row1) =>
                //     //     row.evaluator_ratings - row1.evaluator_ratings
                // },
                selector: (row) =>
    ...
    let list = tableData;
    list &&
        list.evaluator_ratings &&
        list.evaluator_ratings[0].sort((a, b) =>
            a.overall_avg > b.overall_avg ? 1 : -1
        );
